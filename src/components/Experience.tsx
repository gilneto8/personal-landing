...
const experiences = [
  {
    ...
    description: 'Building and operating B2B utilities solo — infrastructure, backend, UI, billing, ops — on a single Hetzner CCX23 VPS, plus contract work as a senior full-stack engineer on AI product teams.',
    highlights: [
