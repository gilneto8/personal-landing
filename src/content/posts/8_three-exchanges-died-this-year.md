...
Three mid-tier crypto exchanges shut down in 2026. AscendEX stopped operating on 1 July. BitMEX announced its closure on 23 July and closes today, 23 September. CoinEx is winding down in steps: spot trading ends on 29 September and withdrawals stay open until 22 December. By mid-year, something like 99 crypto projects had died in total, but those three are the ones that matter here, because people used them like accounts.
...
The easy story is "MiCA killed them". It's close, but the date people quote is wrong. MiCA started applying to crypto-asset service providers on 30 December 2024. The 1 July 2026 date that keeps showing up is only the outer limit of the grandfathering window (Article 143(3)), the grace period for providers already operating under national rules, and several member states ended it earlier than that.
