...
- **Parking is easier to write about than to do.** This isn't the first time in two years I've had to take something off the board, and the thing that made it possible was having somewhere honest to put the reasoning. The analysis becoming a post is not a consolation prize; it's the only thing that made the decision feel like a decision instead of a loss.
